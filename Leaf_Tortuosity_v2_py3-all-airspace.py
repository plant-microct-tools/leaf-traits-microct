...
largest_airspace = airspace_stack #getLargestAirspace(airspace_stack)
largest_airspace_w_stomata = stomata_airspace_stack #getLargestAirspace(stomata_airspace_stack)
